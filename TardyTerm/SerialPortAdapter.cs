    ...
    class SerialPortAdapter
    {
        ...
        public bool Open(string portName)
        {
            ...
            if (InitSerialSettings(portName))
            {
                ...
                task.ContinueWith(c => { MessageBox.Show("Error running serial port read task..", "Oh No!", MessageBoxButtons.OK, MessageBoxIcon.Hand); }, TaskContinuationOptions.OnlyOnFaulted | TaskContinuationOptions.ExecuteSynchronously);
                ret = true;
